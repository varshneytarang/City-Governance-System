...
import { 
  ...
  Workflow, PlayCircle, Wrench, Shield
} from 'lucide-react'
...
const FinanceAgentPage = () => {
  ...
  useEffect(() => {
    const fetchActivities = async () => {
      try {
        const response = await fetch(`${API_BASE}/api/task-orchestration/recent-activities/finance?limit=10`)
        if (response.ok) {
          const data = await response.json()
      ...
      <div className={`min-h-screen relative overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              <TaskOrchestrationDashboard department="finance" />
            </motion.div>
            ...
            <motion.div
              ...
              className="mb-8 col-span-full"
            >
              <DepartmentWorkflows department="finance" />
            </motion.div>
                ...
                <div className="bg-gradient-to-r from-indigo-500 to-blue-500 p-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-indigo-100 text-sm">Completed workflows</p>
                    </div>
                    ...
                    recentActivities.slice(0, 6).map((activity, index) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className="backdrop-blur-sm bg-white/80 border border-indigo-200 rounded-2xl p-4 hover:bg-white hover:shadow-md transition-all cursor-pointer"
                        >
