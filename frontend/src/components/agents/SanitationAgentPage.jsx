...
import { 
  ...
  Workflow, PlayCircle, FileText, Wrench, Shield
} from 'lucide-react'
...
const SanitationAgentPage = () => {
  ...
  useEffect(() => {
    const fetchActivities = async () => {
      try {
        const response = await fetch(`${API_BASE}/api/task-orchestration/recent-activities/sanitation?limit=10`)
        if (response.ok) {
          const data = await response.json()
      ...
      <div className={`min-h-screen relative overflow-hidden bg-gradient-to-br from-green-50 via-cyan-50 to-blue-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              <TaskOrchestrationDashboard department="sanitation" />
            </motion.div>
            ...
            <motion.div
              ...
              className="mb-8 col-span-full"
            >
              <DepartmentWorkflows department="sanitation" />
            </motion.div>
          </div>
                ...
                <div className="bg-gradient-to-r from-cyan-500 to-green-500 p-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-cyan-100 text-sm">Completed workflows</p>
                    </div>
                    ...
                    recentActivities.slice(0, 6).map((activity, index) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className="backdrop-blur-sm bg-white/80 border border-green-200 rounded-2xl p-4 hover:bg-white hover:shadow-md transition-all cursor-pointer"
                        >
