...
def _generate_conversational_response(client, state: dict, escalate: bool, 
    ...
    try:
        ...
        prompt = f"""You are a helpful Finance Department AI assistant. A user asked: "{user_query}"
...
Your response:"""
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "You are a friendly, knowledgeable Finance Department AI assistant. Respond naturally and conversationally."},
